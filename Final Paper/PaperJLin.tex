...
\begin{table}
	...
	\begin{tabulary}{\linewidth}{l c c c c c c}
		...
		\hline
		Small Town                          & - .4973           & -.3295***             &-.1436                         &  .6419***   &             & \\      
		                                                & (.4333)            & (.1087)                      & (.2864)                         & (.2060)        &          &  \\
		Suburban                            & -.2663***           & .0912                  & -                                     & - .1095      &           & \\ 
	                                                  	& (.0852)                   & (.1693)              & -                                    & (.3871)      &          &  \\
		Urban                                      & -.8650***         & -.6361***        & -.2151                     & .3048**      &          &    \\
	                                                    	& (.0976)          &(.1311)                     & (.2406)                       & (.1526)        &            &  \\
		Constant                                    & 5.462          & 4.630                   & 5.9674                        & 7.009       &             &   \\
		N 									              & 4,728               &1,697                & 957                               & 1,179     &           &  \\
		$R^2$							           & 0.0191           &0.0176                  &0.0035                        &0.0097     &           &  \\
		\hline                                       
	\end{tabulary} 
	\\
	\e{Notes:} *p$<$.1, **p$<$.05. ***p$<$.01 \\
