...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Graph displaying voter turnout as a function of the registered voters AND voting age population.
		\item Graph displaying voter turnout percentage based on place of residence characteristics by country
	\end{enumerate}
\end{enumerate}
